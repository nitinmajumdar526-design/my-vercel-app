...
const oldImages = ref([])
const newImages = ref([])
const newImagesLabel = ref('Click to upload multiple images')
...
const handleImages = (e) => {
  ...
  newImagesLabel.value = files.length
...
const updateGallery = async () => {
  ...
  await fetch(`http://localhost:5000/api/gallery/${route.params.id}`, {
    method: 'PUT',
    body: formData
  })
  ...
  <div class="ap-card">
    ...
    <div class="ap-body">
      ...
      <div class="ap-images-section">
        <span class="field-label">Current images ({{ oldImages.length }})</span>
    ...
    <div class="ap-footer">
      ...
      <div class="ap-btn-group">
        <button class="ap-btn-submit" @click="updateGallery">
